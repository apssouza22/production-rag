...
src/domain/arxiv_ingestion/            # Ingestion pipeline task implementations
    ├── common.py                      # Shared service wiring
    ├── exceptions.py                  # Ingestion pipeline exceptions
    ├── fetching.py                    # arXiv fetch + PDF processing tasks
    ├── indexing.py                    # Hybrid OpenSearch indexing tasks
    ├── reporting.py                   # Daily report generation
    ├── service.py                     # MetadataFetcher core service
